...
if (isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO innovision (name, participant, phone_number, alternative, email_id, state, district, college_name, project_name, code, qrcode, image) VALUES ('$name', '$participants', '$phone', '$alternative', '$email_id', '$state', '$district', '$college', '$projects', '$code',' $qrcodeFileName','$image')";
