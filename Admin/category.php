              ...
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <form class="forms-sample" action="registration.php" method="POST">
                      <div class="form-group">
                        <label for="event_name">Event Name</label>
                        <input type="text" class="form-control" name="event_name" required   id="exampleInputName1" placeholder="Event Name">
                      </div>
                      <div class="form-group">
                        <label for="organization_details">Organization Details</label>
                        <input type="text" class="form-control" name="organization_details" required   id="exampleInputName1" placeholder="Organization Details">
                      </div>
                      <div class="form-group">
                        <label for="event_details">Event Details</label>
                        <input type="text" class="form-control" name="event_details" required   id="exampleInputName1" placeholder="Event Details">
                      </div>
                      
                      

                        <div class="form-group ">
                          <label for="time_location">Time Location</label>
                          
                            <input class="form-control" name="time_location"required  placeholder="dd/mm/yyyy" />
                          
                        </div>
                        <div class="form-group">
                          <label for="event_cost">Event Cost</label>
                          <input type="text" class="form-control" name="event_cost" required   id="exampleInputName1" placeholder="Event Cost">
                        </div>
                        <div class="form-group">
                          <label for="organization_upi">Organization UPI</label>
                          <input type="text" class="form-control" name="organization_upi"  required  id="exampleInputName1" placeholder="Organization UPI">
                        </div>
                        <div class="form-group">
                          <label for="event_status">Event Status</label>
                          <input type="text" class="form-control" name="event_status" required id="exampleInputName1" placeholder="Event Status">
                        </div>
                        <div class="form-group">
                          <label for="event_div">Event</label>
                          <input type="text" class="form-control" name="event_div" required id="exampleInputName1" placeholder="Event">
                        </div>
                      <!-- <div class="form-group">
                      ...
                      <!-- <div class="form-group">
                        <label for="exampleTextarea1">Game Description</label>
                                  ...
                                  {  
                                    ...
                                    while($rows=mysqli_fetch_array($result))
                                    {
                                      ...
                                      echo ' <tr>
                                            ...
                                            <td>'.$rows['organization_details'].'</td>
                                            <td>'.$rows['event_details'].'</td>
                                            <td>'.$rows['time_location'].'</td>
                                            <td>'.$rows['event_cost'].'</td>
                                            <td>'.$rows['organization_upi'].'</td>
                                            <td>'.$rows['event_status'].'</td>'
