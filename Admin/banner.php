              ...
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <form class="forms-sample" action="banner_action.php" method="POST">
                      <div class="form-group">
                        <label for="content">Content Name</label>
                        <input type="text" class="form-control" name="content" required   id="exampleInputName1" placeholder="Event Name">
                      </div>
                      <div class="form-group">
                        <label for="date">Event Date</label>
                        <input type="date" class="form-control" name="event_date" required   id="exampleInputName1">
                      </div>
